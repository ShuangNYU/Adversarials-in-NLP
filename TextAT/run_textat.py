...
def train(args, train_dataset, model, tokenizer):
    ...
    delta_global_embedding = torch.zeros([30522, 768]).uniform_(-1,1) # hard-code for BERT-BASE-uncased
    # 30522 bert
    # 50265 roberta
    # 21128 bert-chinese
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            traditional_training = 0

            if traditional_training == 1:
                ...
                for astep in range(args.adv_steps):
                    ...
                    # norm ball
                    total_delta = delta_lb + delta_tok

                    delta_norm_tok = torch.norm(total_delta, p=2, dim=-1).detach() # B seq-len
                    ...
                    reweights_tok = reweights * reweights_tok # B seq-len 1
                    delta_lb = (delta_lb * reweights_tok).detach()
                    delta_tok = (delta_tok * reweights_tok).detach()
